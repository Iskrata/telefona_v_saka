...
void loop() {
  ...
  int lamp1,lamp11,lamp2,lamp22;
  if (req.indexOf("/lamp1/0") != -1) {
   lamp1 = 0;
   digitalWrite(2, lamp1);
  } else if (req.indexOf("/lamp1/1") != -1) {
    lamp1 = 1;
    digitalWrite(2, lamp1);
     } else if (req.indexOf("/lamp1/3") != -1) {
        lamp11=digitalRead(2);
        client.print(lamp11);
  }
